...
namespace WebFramework.Api
{
    ...
    public class ApiResult
    {
        ...
        // دونه دونه حالات رو تعریف می کنیم تا نیاز به تعریف مجدد در هر متد نباشد
        ...
        // کل خطاهای داخل 
        // ModelState
        // را بهم متصل میکنه و برمیگردونه
    ...
    // این کلاس بصورت جنریک بجای فیلد
    // data ساخته شده
    // برای اینکه اگر دیتا نداشتیم از بالایی و وقتی دیتا داشتیم از این استفاده کنیم
    public class ApiResult<TData> : ApiResult
        where TData : class
    {
        // این پراپرتی باعث میشه اگر مقدار دیتا نال بود اصلا به خروجی منتقل نکنه
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
