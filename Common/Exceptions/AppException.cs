...
namespace Common.Exceptions
{
    public class AppException : Exception
    {
        ...
        // علاوه بر کد خطا مثلا بخواهیم فیلد خطا رو هم برگردونیم
        ...
        // در این  سازنده کلیه جزییات خطا رو برمی گردونه
        // کل سازنده های بالا پدرشون این هست و هرکدوم به نحوی این رو صدا زدند
