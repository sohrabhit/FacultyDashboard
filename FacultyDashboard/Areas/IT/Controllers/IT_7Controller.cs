...
namespace FacultyDashboard.Areas.IT.Controllers
{
    ...
    public class IT_7Controller : Controller
    {
        private IWebHostEnvironment Environment;
        private readonly IRepository<User> _Userrepository;
        private readonly IHubContext<dataHub> dataHub;
        private readonly UserManager<User> userManager;
        private readonly IIT_7_Repository _repository;
        private readonly IRepository<Notification> _Noti_repository;
        private readonly IRepository<IT_7> _datarepository;
        private readonly ILogger<IT_7Controller> logger;
        private readonly IMapper _mapper;

        public IT_7Controller(IHubContext<dataHub> _DataHub, IRepository<Notification> noti,
            IRepository<IT_7> _Repository, IIT_7_Repository ar, UserManager<User> userManager
            , ILogger<IT_7Controller> logger, IMapper mapper, IWebHostEnvironment _environment
        ...
        {
            IT_7_ListViewModel Model = new IT_7_ListViewModel();
            if (HttpContext.Request.QueryString.HasValue && HttpContext.Request.QueryString.Value.Contains("&"))
            {
                ...
                {
                    Model = new IT_7_ListViewModel();
                    Model.Datas = _datarepository.Search(SearchParameters, new IT_7());
                }
            }
            else
        ...
        public async Task<IActionResult> Save(int uriidForEdit, string datas)
        {
            ...
            if (model != null)
            {
                ...
                await dataHub.Clients.All.SendAsync("GetNotification", "IT_7");
