...
namespace FacultyDashboard.Areas.IT.Controllers
{
    ...
    public class IT_2Controller : Controller
    {
        private IWebHostEnvironment Environment;
        private readonly IRepository<User> _Userrepository;
        private readonly IHubContext<dataHub> dataHub;
        private readonly UserManager<User> userManager;
        private readonly IIT_2_Repository _repository;
        private readonly IRepository<Notification> _Noti_repository;
        private readonly IRepository<IT_2> _datarepository;
        private readonly ILogger<IT_2Controller> logger;
        private readonly IMapper _mapper;

        public IT_2Controller(IHubContext<dataHub> _DataHub, IRepository<Notification> noti,
            IRepository<IT_2> _Repository, IIT_2_Repository ar, UserManager<User> userManager
            , ILogger<IT_2Controller> logger, IMapper mapper, IWebHostEnvironment _environment
        ...
        {
            IT_2_ListViewModel Model = new IT_2_ListViewModel();
            if (HttpContext.Request.QueryString.HasValue && HttpContext.Request.QueryString.Value.Contains("&"))
            {
                ...
                {
                    Model = new IT_2_ListViewModel();
                    Model.Datas = _datarepository.Search(SearchParameters, new IT_2());
                }
            }
            else
        ...
        public async Task<IActionResult> Save(int uriidForEdit, string datas)
        {
            ...
            if (model != null)
            {
                ...
                await dataHub.Clients.All.SendAsync("GetNotification", "IT_2");
        ...
        public static Expression<Func<IT_2, bool>> Condition(DateTime? StartDate, DateTime? EndDate)
        {
