...
namespace FacultyDashboard.Areas.IT.Controllers
{
    ...
    public class IT_1Controller : Controller
    {
        private IWebHostEnvironment Environment;
        private readonly IRepository<User> _Userrepository;
        private readonly IHubContext<dataHub> dataHub;
        private readonly UserManager<User> userManager;
        private readonly IIT_1_Repository _repository;
        private readonly IRepository<Notification> _Noti_repository;
        private readonly IRepository<IT_1> _datarepository;
        private readonly ILogger<IT_1Controller> logger;
        private readonly IMapper _mapper;

        public IT_1Controller(IHubContext<dataHub> _DataHub, IRepository<Notification> noti,
            IRepository<IT_1> _Repository, IIT_1_Repository ar, UserManager<User> userManager
            , ILogger<IT_1Controller> logger, IMapper mapper, IWebHostEnvironment _environment
        ...
        {
            IT_1_ListViewModel Model = new IT_1_ListViewModel();
            if (HttpContext.Request.QueryString.HasValue && HttpContext.Request.QueryString.Value.Contains("&"))
            {
                ...
                {
                    Model = new IT_1_ListViewModel();
                    Model.Datas = _datarepository.Search(SearchParameters, new IT_1());
                }
            }
            else
        ...
        public async Task<IActionResult> Save(int uriidForEdit, string datas)
        {
            ...
            if (model != null)
            {
                ...
                await dataHub.Clients.All.SendAsync("GetNotification", "IT_1");
        ...
        public static Expression<Func<IT_1, bool>> Condition(DateTime? StartDate, DateTime? EndDate)
        {
