...
namespace FacultyDashboard.Areas.IT.Controllers
{
    ...
    public class IT_4Controller : Controller
    {
        private IWebHostEnvironment Environment;
        private readonly IRepository<User> _Userrepository;
        private readonly IHubContext<dataHub> dataHub;
        private readonly UserManager<User> userManager;
        private readonly IIT_4_Repository _repository;
        private readonly IRepository<Notification> _Noti_repository;
        private readonly IRepository<IT_4> _datarepository;
        private readonly ILogger<IT_4Controller> logger;
        private readonly IMapper _mapper;

        public IT_4Controller(IHubContext<dataHub> _DataHub, IRepository<Notification> noti,
            IRepository<IT_4> _Repository, IIT_4_Repository ar, UserManager<User> userManager
            , ILogger<IT_4Controller> logger, IMapper mapper, IWebHostEnvironment _environment
        ...
        {
            IT_4_ListViewModel Model = new IT_4_ListViewModel();
            if (HttpContext.Request.QueryString.HasValue && HttpContext.Request.QueryString.Value.Contains("&"))
            {
                ...
                {
                    Model = new IT_4_ListViewModel();
                    Model.Datas = _datarepository.Search(SearchParameters, new IT_4());
                }
            }
            else
        ...
        public async Task<IActionResult> Save(int uriidForEdit, string datas)
        {
            ...
            if (model != null)
            {
                ...
                await dataHub.Clients.All.SendAsync("GetNotification", "IT_4");
        ...
        public static Expression<Func<IT_4, bool>> Condition(DateTime? StartDate, DateTime? EndDate)
        {
