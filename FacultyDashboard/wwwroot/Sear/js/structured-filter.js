              ...
              case fTypes.listDropdown:
                ...
                /*case fTypes.number:
                    if (fType == fTypes.date)
                        h += '<input id="value" type="text" data-jdp>';
                    else
                        h += '<input id="value" type="text">';
                    if (opBetween) {
                        if (fType == fTypes.date)
                            h += '<span class="as-Txt">' + i18n.opAnd + " </span>" + '<input id="value2" type="text" data-jdp>';
                        else
                            h += '<span class="as-Txt">' + i18n.opAnd + " </span>" + '<input id="value2" type="text">';
                    }*/
                case fTypes.number:
